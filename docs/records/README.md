...
| 최신 Stage 1 순차 25영역 결과 | `training/20260614_stage1_cameraaudit_operating_workspace_analysis.md` |
| 최신 Stage 1 16/17 focus 결과 | `training/20260614_stage1_region16_17_radius_ladder_analysis.md` |
